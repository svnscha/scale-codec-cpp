...
public:
   ...
   * @return reference to stream
   */
  template <class... T> ScaleDecoderStream &operator>>(std::tuple<T...> &v) {
   ...
   * @return reference to stream
   */
  template <class T> ScaleDecoderStream &operator>>(std::shared_ptr<T> &v) {
   ...
   * @return reference to stream
   */
  template <class T> ScaleDecoderStream &operator>>(std::unique_ptr<T> &v) {
    using mutableT = std::remove_const_t<T>;
   ...
   * @return reference to stream
   */
  template <class T> ScaleDecoderStream &operator>>(std::vector<T> &v) {
    using mutableT = std::remove_const_t<T>;
   ...
   * @return reference to stream
   */
  template <class T> ScaleDecoderStream &operator>>(std::list<T> &v) {
    using mutableT = std::remove_const_t<T>;
    using size_type = typename std::list<T>::size_type;
  ...
  SizeType currentIndex() const { return current_index_; }
